				...
				<div className="section-container">
					...
					<div className="row-3col">
						<Callout
							...
							content='Pixelated can be your Virtual Technology Department, 
						...
						<Callout
							...
							content='Let Pixelated help you develop a comprehensive social media strategy that aligns with your business goals.
						...
						<Callout
							...
							content='Pixelated can help you improve your websites visibility and ranking on popular search engines.
						...
						<Callout
							...
							content='Pixelated can help you implement a content management system (CMS) 
						...
						<Callout
							...
							content='Pixelated can help you set up and manage an eCommerce platform that meets your business needs.
						...
						<Callout
							...
							content='Pixelated can help you develop custom business solutions that streamline your operations 
